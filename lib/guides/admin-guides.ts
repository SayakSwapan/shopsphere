...
export const adminGuides: PageGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Payment methods", detail: "In Product Settings, choose 'Online Payment Methods' for this product: both, online only, or COD only. Offline (POS) sales are always allowed regardless. Customers can only pay with the method(s) you allow at checkout — the system enforces it server-side too." },
