  ...
  return (
    <PageContainer>
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-black tracking-tight text-white">Return Requests</h1>
        <p className="mt-1 text-slate-500">Review and manage customer return requests.</p>
      </div>
                ...
                return (
                  <tr key={r.id} className="border-b border-slate-800 last:border-0">
                    <td className="px-6 py-4">
                      <Link href={`/admin/returns/${r.id}`} className="font-semibold text-white hover:text-amber-400 hover:underline">
                        {r.order.orderNumber}
                      </Link>
