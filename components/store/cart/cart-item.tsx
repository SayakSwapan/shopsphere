    ...
    >
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        >
          <Image
            src={
              optimizedImageUrl(item.product.productimage?.[0]?.url, 240) ??
              "/placeholder.png"
            }
        ...
        <div className="flex flex-1 flex-col justify-between">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {item.productvariant?.size && (
                <span
                  ...
                  style={{
                    borderRadius:
                      themeId === "fashion" ? "999px" : "var(--t-radius-badge)",
                    background:
              ...
              {item.productvariant?.stock !== undefined && (
                ...
                >
                  {item.productvariant.stock <= 5
                    ? `Only ${item.productvariant.stock} left`
                    : `${item.productvariant.stock} in stock`}
                </span>
              )}
            </div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:gap-5 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div>
              ...
              <h3
                className="mt-1 text-2xl sm:text-3xl font-black text-text-heading"
                style={{ fontFamily: "var(--t-font-heading)" }}
              >
            ...
            <div className="flex items-center gap-5">
              ...
              <button
                ...
                style={{
                  ...
                  border:
                    "1px solid color-mix(in srgb, var(--t-danger) 40%, transparent)",
                }}
                onMouseEnter={(e) => {
