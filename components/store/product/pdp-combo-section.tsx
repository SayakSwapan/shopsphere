...
export default async function PdpComboSection({
  productId,
}: {
  productId: string;
}) {
  ...
  return (
    ...
    >
      <div className="space-y-5">
        {combos.map((combo) => {
          const others = combo.items.filter(
            ...
            >
              ...
              <div className="relative z-10 flex flex-col gap-4 p-5 sm:p-7 md:flex-row md:items-center md:gap-8">
                ...
                <div className="md:w-2/5">
                  ...
                  {combo.headline && (
                    <p className="mt-1.5 text-sm text-text-muted-1">
                      {combo.headline}
                    </p>
                  )}
                  <div
                ...
                <div className="flex-1 overflow-x-auto">
                  <p
                    className="mb-3 text-[10px] font-black uppercase tracking-[0.25em] text-text-muted-2"
                    style={{ fontFamily: "var(--t-font-heading)" }}
                  >
                  ...
                  <div className="flex items-stretch gap-3">
                    ...
                    {others.length === 0 && (
                      <p
                        className="text-sm text-text-muted-2"
                        style={{ fontFamily: "var(--t-font-body)" }}
                      >
                        This combo already includes every product. Shop the deal
